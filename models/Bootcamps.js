...
const BootcampsSchema = new Schema({
    ...
    careers: {
        ...
        type: [String],
        required: true,
        // enum - může mít jen tyto hodnoty
        enum: [
            'Web Development',
            'Mobile Development',
            'UI/UX',
    ...
    user: {
        type: mongoose.Schema.ObjectId, // [dfsdfsdf] // mongoose.Schema.Types.ObjectId
        ref: 'User',
        required: true,
    }
}, {
...
BootcampsSchema.virtual('courses', { // propojeni tady {FSKJ}
    ref: 'Course',
    localField: '_id',
    foreignField: 'bootcamp', // propojeni tady {POJBJ}
    justOne: false
})
